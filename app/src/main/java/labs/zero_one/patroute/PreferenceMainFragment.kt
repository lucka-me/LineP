            ...
            override fun onPreferenceClick(preference: Preference?): Boolean {
                ...
                doAsync {
                    ...
                    try {
                        ...
                        serverURL =
                            sharedPreference.getString(getString(R.string.pref_server_url_key), "")
                        serverPort =
                            sharedPreference
                                .getString(
                                ...
                                .toInt()
                        username =
                            sharedPreference.getString(getString(R.string.pref_user_id_key), "")
                        password =
                            sharedPreference.getString(getString(R.string.pref_user_token_key), "")
                        enableFTPS =
                            sharedPreference
